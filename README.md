...
- **OneDay** — 本地优先的生活记录 · macOS
- **Markdown** — 原生阅读、编辑与分享 · macOS
- **OneDayCapture** — 一日一拍：拍摄、提词、字幕、成片 · iOS
- **邻里拼** — 小区拼单，认商品、算费用 · 小程序
- **简历通** — 原生简历编辑器 · macOS

也在养：[obsidian-advanced-play](https://github.com/chudengchutx/obsidian-advanced-play) · EnglishDiary

<details>
<summary>仓库全表 · 按最近更新</summary>

> 排得越前 = 最近越活跃。🔒 为私有仓库（仅自己可见链接）。
...
| 仓库 | 说明 | 最近更新 |
|---|---|---|
| 🔒 **Markdown** | 原生 macOS Markdown 阅读、编辑与分享工具 | 2026-08-31 |
| 🔒 **oneday** | OneDay macOS 本地优先生活记录工具 | 2026-08-31 |
| 🔒 **OneDayCapture** | 一日一拍：iPhone 视频日记拍摄、提词、字幕校对与成片导出 | 2026-08-31 |
| 🔒 **linglipin** | 小区拼单不用愁，「邻里拼」来帮你分忧。一键AI识别商品信息，自动统计费用，告别群内统计乱象，轻松搞定小区拼单。 | 2026-08-31 |
| 🔒 **jianlitong** | 简历通：原生 macOS SwiftUI 简历编辑器 | 2026-08-31 |
| 🔒 **lucas-site** | — | 2026-08-22 |
...
| 🔒 **personal-website** | — | 2026-08-06 |
| [ai-personal-tools](https://github.com/chudengchutx/ai-personal-tools) | AI-assisted personal tools: membership price parser, job … | 2026-05-05 |
| 🔒 **claude-code-history** | — | 2026-04-15 |
| 🔒 **magic** | — | 2026-04-15 |
| 🔒 **movie** | — | 2026-04-15 |
| 🔒 **peek** | — | 2026-04-15 |
| 🔒 **EnglishDiary** | 英语学习日记 iOS App — SwiftUI + SQLite + iCloud 同步 | 2026-04-14 |
| 🔒 **learning-English** | — | 2026-04-14 |
<!-- OWN_REPOS:END -->
